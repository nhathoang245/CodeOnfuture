...
const Dashboard = () => {
    ...
    const dashboardCards = [
      {title: "Total Devices", value: data.totalDevices, icon: assets.deviceIconColored},
    ...
    const fetchDashboardData = async()=>{
      try {
        ...
        if(data.success){
          ...
          console.log("Error at else fetchDashboardData of Dashboard")
          toast.error(data.message)
        }
      } catch (error) {
        console.log("Error at catch fetchDashboardData of Dashboard")
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform performance including total devices, bookings, revenue, and recent activities"/>
          ...
          {data.recentBookings.map((booking, index)=>(
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p>{booking.device.brand} {booking.device.model}</p>
